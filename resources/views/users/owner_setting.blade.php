                        ...
                        <div class="row">
                            <div class="col-12">
                                <div id="payment-gateways" class="accordion accordion-spaced">
                                    ...
                                    <!-- Paymentwall -->
                                   <div class="card">
                                        <div class="card-header py-4" id="paymentwall-payment" data-toggle="collapse" role="button" data-target="#collapse-paymentwall" aria-expanded="false" aria-controls="collapse-paymentwall">
                                            <h6 class="mb-0"><i class="far fa-credit-card mr-3"></i>{{__('PaymentWall')}}</h6>
                                        </div>
                                        <div id="collapse-paymentwall" class="collapse" aria-labelledby="paymentwall-payment" data-parent="#payment-gateways">
                                            <div class="card-body">
                                                <div class="row">
                                                    <div class="col-6 py-2">
                                                    ...
                                                    <div class="col-6 py-2 text-right">
                                                        <div class="custom-control custom-switch">
                                                            ...
                                                            <input type="checkbox" class="custom-control-input" name="is_paymentwall_enabled" id="is_paymentwall_enabled" {{ isset($payment_detail['is_paymentwall_enabled'])  && $payment_detail['is_paymentwall_enabled']== 'on' ? 'checked="checked"' : '' }}>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    {{-- {{ Form::text('', $details['address'], ['class' => 'form-control','required' => 'required']) }} --}}
                                    <input type="text" name="zoom_api_key"   placeholder="Zoom API Key" value="{{ !empty($settings['zoom_api_key']) ? $settings['zoom_api_key'] : '' }}" class="form-control">
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-group">
