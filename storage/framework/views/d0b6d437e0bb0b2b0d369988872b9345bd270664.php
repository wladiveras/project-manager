...
<head>
    ...
    <title><?php echo e(__('Messages')); ?> &dash; <?php echo e((Utility::getValByName('header_text')) ? Utility::getValByName('header_text') : config('app.name')); ?></title>
    <link rel="icon" href="<?php echo e(asset(Storage::url('logo/favicon.png'))); ?>" type="image/png">
                ...
                <div class="row text-center text-sm-left align-items-sm-center">
                    ...
                    <div class="col-sm-6 mb-md-0">
                        <ul class="nav justify-content-center justify-content-md-end">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="<?php echo e(\App\Models\Utility::getValByName('footer_value_1')); ?>"><?php echo e(\App\Models\Utility::getValByName('footer_link_1')); ?></a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="<?php echo e(\App\Models\Utility::getValByName('footer_value_2')); ?>"><?php echo e(\App\Models\Utility::getValByName('footer_link_2')); ?></a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="<?php echo e(\App\Models\Utility::getValByName('footer_value_3')); ?>"><?php echo e(\App\Models\Utility::getValByName('footer_link_3')); ?></a>
                            </li>
                        </ul>
                    </div>
                </div>
...
<?php /**PATH /home/wladiveras.com/public_html/resources/views/layouts/admin.blade.php ENDPATH**/ ?>