                                            ...
                                            <div class="d-flex align-items-center justify-content-between">
                                                ...
                                                <div class="flex-fill pl-3 text-limit">
                                                    ...
                                                    <div class="d-flex justify-content-between text-xs text-muted text-right mt-1">
                                                        <div>
                                                            <span class="font-weight-bold text-<?php echo e(\App\Models\Project::$status_color[$due_project->status]); ?>"><?php echo e(\App\Models\Project::$status[$due_project->status]); ?></span>
                                                        </div>
                                                        <div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/wladiveras.com/public_html/resources/views/admin/dashboard.blade.php ENDPATH**/ ?>